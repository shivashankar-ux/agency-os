-- ============================================================
-- AGENCY OS — Migration 012: Restrict member all_clients default
-- ============================================================

-- Recreate has_permission to exclude standard 'member' role from having 'all_clients' visibility by default
...
begin
  ...
  if v_has_custom then
    ...
    if feature = 'all_clients' then
      return v_role in ('owner', 'admin', 'manager'); -- EXCLUDED 'member' so standard members only see assigned clients
