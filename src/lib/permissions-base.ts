...
export const ROLE_DEFAULTS: Record<string, PermissionMap> = {
  owner: {
    ...
    calendar: { view: { allowed: true, scope: "all" }, create: { allowed: true, scope: "all" }, edit: { allowed: true, scope: "all" }, delete: { allowed: true, scope: "all" } },
  ...
  member: {
    ...
    clients: { view: { allowed: true, scope: "all" }, create: { allowed: false, scope: "own" }, edit: { allowed: false, scope: "own" }, delete: { allowed: false, scope: "own" }, export: { allowed: false, scope: "own" } },
    ...
    calendar: { view: { allowed: true, scope: "own" }, create: { allowed: false, scope: "own" }, edit: { allowed: false, scope: "own" }, delete: { allowed: false, scope: "own" } },
