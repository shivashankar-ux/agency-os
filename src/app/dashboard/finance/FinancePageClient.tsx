...
export default function FinancePageClient({ initialInvoices, clients }: FinancePageClientProps) {
  ...
  async function handleCreateInvoice(e: React.FormEvent) {
    ...
    if (!formData.invoice_number || !formData.client_id || !formData.amount) {
      setFormError("Invoice number, client, and base amount are required.");
      return;
    }
    ...
    try {
      ...
      const parsedGst = parseFloat(formData.gst_amount || "0");
